...
{
    /// <summary>
    /// Converts a <see cref="LogoColorsRecord"/> into an SVG string representation.
    /// Used to render themed logos in the UI based on user-selected or system-defined colors.
    /// </summary>
    /// <remarks>
    /// Delegates SVG generation to <see cref="LogoHelper.GetLogoAsXDocument(LogoColorsRecord)"/>.
    ...
    {
        /// <summary>
        /// Converts a <see cref="LogoColorsRecord"/> into an SVG string.<br/>
        /// <seealso cref="LogoHelper.GetLogoAsXDocument(LogoColorsRecord)"/>
        /// </summary>
        /// <param name="value">Expected to be a <see cref="LogoColorsRecord"/>.</param>
        ...
        {
            return value is LogoColorsRecord lcr
